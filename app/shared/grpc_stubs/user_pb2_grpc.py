...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListUsers = channel.unary_unary(
                ...
                _registered_method=True)
        self.UploadAvatar = channel.stream_unary(
                '/user.UserService/UploadAvatar',
                request_serializer=user__pb2.AvatarChunk.SerializeToString,
                response_deserializer=user__pb2.User.FromString,
                _registered_method=True)
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UploadAvatar': grpc.stream_unary_rpc_method_handler(
                    servicer.UploadAvatar,
                    request_deserializer=user__pb2.AvatarChunk.FromString,
                    response_serializer=user__pb2.User.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    @staticmethod
    def UploadAvatar(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/user.UserService/UploadAvatar',
            user__pb2.AvatarChunk.SerializeToString,
            user__pb2.User.FromString,
            options,
            channel_credentials,
            insecure,
